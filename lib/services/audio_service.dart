...
class AudioService {
  ...
  /// Stream du nombre de pas (uint32, mis à jour par notifications BLE)
  Stream<int> get stepCountStream => _bleService.stepCountStream;

  /// Nombre de pas actuel
  int get stepCount => _bleService.stepCount;

  /// true si la montre est connectée (connected ou syncing)
