...
class BleConstants {
  ...
  /// UUID de la caractéristique Step Count (Read + Notify: firmware → téléphone)
  /// Envoie le nombre total de pas (uint32 little-endian, 4 bytes)
  static const String stepCountCharacteristicUuid =
